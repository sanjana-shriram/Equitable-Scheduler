...
//     // Calculate average of the top 50 maximum latencies
//     // std::vector<long long> maxLatenciesVector;
//     // while (!maxLatencies.empty()) {
//     //     maxLatenciesVector.push_back(maxLatencies.top());
//     //     maxLatencies.pop();
//     // }
//     // std::sort(maxLatenciesVector.begin(), maxLatenciesVector.end(), std::greater<long long>());
//     // double sumOfMaxLatencies = 0.0;
//     // for (int i = 0; i < std::min(50, static_cast<int>(maxLatenciesVector.size())); ++i) {
//     //     sumOfMaxLatencies += maxLatenciesVector[i];
//     // }
//     // double averageOfMaxLatencies = sumOfMaxLatencies / std::min(50, static_cast<int>(maxLatenciesVector.size())); // Divide by 50 since we are averaging 50 maximum latencies
...
//     std::ofstream outFile("second_results_sjf_scheduler.csv", std::ios::app);
